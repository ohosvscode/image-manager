...
- 205abd8: fix: EmulatorFoldItem single screen size

## 0.5.12-beta.3

### Patch Changes

- c43bf3e: fix: EmulatorFoldItem single screen size"
...
- 62fa844: fix: fix triplefold configuration
...
- 4d2baf5: fix: getDeviceItems maximum call stack size exceeded
